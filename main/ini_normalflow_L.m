...
%$Author: V $
%$Id: ini_normalflow_L.m 106 2017-06-27 12:45:13Z V $
%$HeadURL: https://131.180.60.193/svn/ELV/branches/V0123/main/ini_normalflow_L.m $
%
...
[qbk0_pred,~]=sediment_transport(input.aux.flg,input.aux.cnt,h0,h0*u0,Cfb,1,Fak0,input.sed.dk,input.tra.param,input.aux.flg.hiding_parameter,1,NaN,NaN);
