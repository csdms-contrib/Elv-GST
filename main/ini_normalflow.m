...
%$Author: V $
%$Id: ini_normalflow.m 79 2017-04-20 11:07:54Z V $
%$HeadURL: https://131.180.60.193/svn/ELV/branches/V0123/main/ini_normalflow.m $
%
...
if exitflag>0 %correct exiting
    ...
    [qbk0_pred,~]=sediment_transport(input.aux.flg,input.aux.cnt,h0,h0*u0,Cf,La,Fak0,input.sed.dk,input.tra.param,input.aux.flg.hiding_parameter,mor_fac,NaN,NaN);
