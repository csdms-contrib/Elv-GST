...
%$Author: V $
%$Id: fig_x_cnt.m 106 2017-06-27 12:45:13Z V $
%$HeadURL: https://131.180.60.193/svn/ELV/branches/V0123/postprocessing/fig_x_cnt.m $
%
...
switch varp
    case 1
        ...
        %get the one we want
        yp=squeeze(F_all(varp2,kxp,1,:));
    case 2
        yp=squeeze(sum(output_m.qbk(:,kxp,:,:),1)).*unitqb;
...
kr=1; kc=1;    
han.p(kr,kc,1)=plot(time_results.*unitt,yp,'parent',han.sfig(kr,kc),'linewidth',prop.lw);
